export const aboutData = {
  ...
  background: {
    title: 'My background',
    text: 'I possess over 2 years of invaluable experience within the IT/Engineering sector, where I have thrived as a Software Engineer/Frontend Engineer.',
  },
  workedWith: {
    ...
    skillsAndTools: [
      ...
      },
      {
        ...
        skills: [
          'Fetch API, Axios, ReactQuery, graphql-request',
          'Consuming RESTful APIs and GraphQL APIs',
        ],
      },
      {
        title: ' State Management:',
        skills: ['Redux / ReduxToolkit'],
      },
      {
